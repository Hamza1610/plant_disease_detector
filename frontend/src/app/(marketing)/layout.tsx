          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/dashboard/models" className="hover:text-green-400">Model Registry</Link></li>
                <li><Link href="/dashboard/predict" className="hover:text-green-400">Prediction Studio</Link></li>
                <li><Link href="/dashboard/benchmarks" className="hover:text-green-400">Benchmarks</Link></li>
              </ul>
            </div>
            <div>
